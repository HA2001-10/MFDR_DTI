...
from model import MFDR_DTI

parser = argparse.ArgumentParser(
    prog='MFDR_DTI',
    description='MFDR_DTI is model in paper: \"Multi-Level Feature Extraction and Multi-Channel Shared Cross-Attention Framework for DTI prediction\"',
...
parser.add_argument('-m', '--model', choices=['MFDR_DTI'],
                    default='MFDR_DTI', help='Which model to use, \"MFDR_DTI\" is used by default')
